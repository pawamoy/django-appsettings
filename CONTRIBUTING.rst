...
When `reporting a bug <https://github.com/Genida/django-appsettings/issues>`_ please include:
...
The best way to send feedback is to file an issue at https://github.com/Genida/django-appsettings/issues.
...
1. Fork `django-appsettings <https://github.com/Genida/django-appsettings>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on...
       ...
       - **Travis**: it will `run the tests <https://travis-ci.org/Genida/django-appsettings/pull_requests>`_ for each change you add in the pull request.
